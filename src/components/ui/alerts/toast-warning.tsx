  ...
  toast.custom(
    (t) => (
      <motion.div
        ...
        className="pointer-events-auto flex w-80 items-start gap-3 rounded-2xl border border-amber-500/20 bg-card/90 p-4 backdrop-blur-xl"
      >
        ...
        <button
          ...
          className="-mr-1 -mt-1 flex h-6 w-6 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:bg-amber-500/10 hover:text-amber-400"
        >
